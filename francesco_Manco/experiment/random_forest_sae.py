...
def sae_cross_validation(X, y, encoding_shape, alpha, num_folds=5, random_state=42):
    ...
    }, f"{save_path}/best_autoencoder_clr_0_7_combined.pt")
    ...
    results_df.to_csv(r"C:\Users\Utente\Desktop\SAE-microbiome\results\SAE_clr_0_7_combined.csv", index=False)
    return mean_results

if __name__ == "__main__":
    # Load dataset
    df = pd.read_csv(r'C:\Users\Utente\Desktop\SAE-microbiome\francesco_Manco\data\df_MV-ASD_clr_combined.csv')
